...
*** Global Configs
Define some configurations like directory paths.
#+NAME: config
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  (defvar *home-dir* (getenv "HOME"))
  (defvar *dotemacs-dir* (concat *home-dir* "/src/dotemacs/"))
  (defvar *node-dir* (concat *home-dir* "/.nvm/versions/node/v9.11.1/bin/"))
...
To make swiper quicker, disable global visual line mode.
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
...
** Introspection
*** M-x Enhancements: Smex for auto complete meta commands
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  (use-package smex
...
**** HTML/CSS
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  (use-package sass-mode :config (setq exec-path (cons (expand-file-name "/usr/bin/sass") exec-path)))
...
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  ...
  (use-package go-mode)
  (use-package emmet-mode :config (add-hook 'sgml-mode-hook 'emmet-mode) (add-hook 'css-mode-hook  'emmet-mode))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle (if (string-equal system-type "gnu/linux") "~/.emacs")
  ...
  (add-hook 'exwm-randr-screen-change-hook
	    (lambda () (start-process-shell-command "xrandr" nil "xrandr --output eDP-1 --mode 2048x1152 --right-of DP-2-2 --auto")))
  (exwm-randr-enable)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle (if (version> org-version "9.2") "~/.emacs
    (require 'org-tempo)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  (use-package elfeed-org :config (elfeed-org) (setq rmh-elfeed-org-files (list "~/org/personal/elfeed.org")))
...
* ---------------------------------------
* ---------------------------------------
* DONE Disable mouse mode and whitespace mode
* TODO Bring in custom configs for osx and linux
* TODO Test test test
  - todo C-c C-t
  - capture templates
* TODO Get new screenshot
* TODO visual line mode
* TODO symbols in ts mode!
* DONE mac scratch configs
* DONE toc
