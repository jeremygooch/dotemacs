...
(global-set-key (kbd "C-c 1")  'jrm3/sync-org)

(defun jrm3/sync-org-on-save ()
...
(add-hook 'after-save-hook 'jrm3/sync-org-on-save)
...
#+BEGIN_SRC emacs-lisp  :tangle ~/.emacs
  ...
  (custom-set-variables
   '(flycheck-typescript-tslint-executable "/Users/jgooch/.nvm/versions/node/v9.6.1/bin/tslint"))
