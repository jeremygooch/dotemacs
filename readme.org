...
#+BEGIN_SRC emacs-lisp :exports code :tangle ~/.emacs
  ...
  (org-agenda-file-to-front (find-lisp-find-files "~/Dropbox/work/softwareadvice/" "|.org$"))
...
Setup account
#+BEGIN_SRC emacs-lisp :exports code :tangle ~/.emacs
  (setq org-jira-working-dir "~/Dropbox/work/softwareadvice/org-jira/")
