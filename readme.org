...
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  ...
  (setq org-capture-templates
        '((" " "TODOs ==============================" entry (file "") "")
          ("w" "Work Todo" entry (file "/Users/jeremygooch/org-roam/20221101090059-teachforward_todos.org")
           "** TODO %? :tf:\n  %i\n  %a")
          ("a" "Acer/Work Todo" entry (file+headline "~/org/work/TeachForward/acer.org" "Todos")
           "** TODO %? :tf:\n  %i\n  %a")
