...
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  ...
  (setq org-capture-templates
	'((" " "TODOs ==============================" entry (file "") "")
	  ...
	  ("t" "TS Snippet" entry (file "~/org/personal/research/development/js/Javascript-snippets.org")
	   "* \n #+BEGIN_SRC typescript\n%?\n#+END_SRC\n\n[Date: %<%Y-%d-%m>]" :prepend t)
	  ("p" "Python Snippet" entry (file "~/org/personal/research/development/js/Javascript-snippets.org")
	   "* \n #+BEGIN_SRC python\n%?\n#+END_SRC\n\n[Date: %<%Y-%d-%m>]" :prepend t)
