...
#+BEGIN_SRC emacs-lisp :exports code :tangle ~/.emacs
  ...
  ;; (setq org-agenda-files (find-lisp-find-files "~/Dropbox/work/softwareadvice" "\.org$"))
  ...
  ;; 		     x)
  ;; 		    (string-match
  ;; 		     (concat "^" (regexp-quote (expand-file-name "~/Dropbox/work/softwareadvice/calendar.org")))
  ;; 		     x)
  ;; 		    (string-match
