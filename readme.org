...
*** Global Configs
Define some configurations like directory paths to a sample config file. After this file is created, copy it to .emacs-config in your home directory.
#+NAME: config
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs-config-SAMPLE
...
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  (let* ((package-root (locate-dominating-file default-directory "package.json"))
	 (path (and package-root
		    (expand-file-name "/home/jrm3/.nvm/versions/node/v10.8.0/bin/node"
...
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  (use-package elfeed-org :config (elfeed-org) (setq rmh-elfeed-org-files (list (concat *org-dir* "personal/elfeed.org"))))
