...
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  (custom-set-variables
   '(grep-find-ignored-directories
     (quote
      ("SCCS" "RCS" "CVS" "MCVS" ".src" ".svn" ".git" ".hg" ".bzr" "_MTN" "_darcs" "{arch}" "node_modules" "vendor" "dist" "coverage" "e2e"))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs 
  ...
  (remove-hook 'before-save-hook 'jrm/stack-imports)
#+END_SRC
...
Stylistic preferences for using the pre-v9 version of org mode (E.g. [[https://orgmode.org/manual/Easy-templates.html][easy templates]] and how to split the source window when editing)
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs
  (require 'org-tempo)
